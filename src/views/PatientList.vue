  ...
  <div class="patient-dashboard">
    ...
    <div class="legend-component">
      <div class="legend-header" @click="toggleCollapse">
        ...
        ></span>
        <h3 class="legend-title">Зубная формула</h3>
      </div>
      <div class="legend" v-if="!isCollapsed">
        <div class="legend-item">
          <span class="legend-marker" style="background-color: white"></span>
          <span>Здоровый зуб</span>
        </div>
        <div class="legend-item">
          <span class="legend-marker" style="background-color: #6c757d"></span>
          <span>Больной зуб</span>
        </div>
        <div class="legend-item">
          <span class="legend-marker" style="background-color: #a3a09b"></span>
          <span>Удаленный зуб</span>
        </div>
        <div class="legend-item">
        ...
        <div class="legend-item">
          <span class="legend-marker" style="background-color: #71b276"></span>
          <span>Имплант</span>
        </div>
        <div class="legend-item">
          <span class="legend-marker" style="background-color: #a3a09b"></span>
        ...
        <div class="legend-item">
          <span class="legend-marker" style="background-color: pink"></span>
          <span>Десна</span>
        </div>
      </div>
    </div>
